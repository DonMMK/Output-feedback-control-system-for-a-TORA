...
h = 0.0001;
%Run simulation of Discrete Time model and Sampled Data model
%DT_NL2 = sim('DT_NL_TORA','Solver','ode4','FixedStep','h','StopTime','stoptime');
SD_NL2 = sim('SD_NL_TORA2','Solver','ode4','FixedStep','h','StopTime','stoptime');
...
hold on
plot(SD_NL.t,r2d(1)*SD_NL.x1(:,1),'r','LineWidth',2)
xlabel('Time(s)')
ylabel('Angle(deg)')
title ('State x1: Angle of rotating actuator')
legend('x1 Discrete-Time Model','x1 Sampled-Data Model','location','northeast')
...
hold on
plot(SD_NL.t,r2d(1)*SD_NL.x2(:,1),'r','LineWidth',2)
xlabel('Time(s)')
ylabel('Angular Velocity(deg/s)')
title ('State x2: Angular velocity of rotating actuator')
legend('x2 Discrete-Time Model','x2 Sampled-Data Model','location','northeast')
...
hold on
plot(SD_NL.t,r2d(2)*SD_NL.x3(:,1),'r','LineWidth',2)
xlabel('Time(s)')
ylabel('Position(m)')
title ('State x3: Position of Translational oscillator')
legend('x3 Discrete-Time Model','x3 Sampled-Data Model','location','northeast')
...
hold on
plot(SD_NL.t,r2d(2)*SD_NL.x4(:,1),'r','LineWidth',2)
xlabel('Time(s)')
ylabel('Velocity')
title ('State x4: Velocity of Translational oscillator')
legend('x4 Discrete-Time Model','x4 Sampled-Data Model','location','northeast')
...
figure('Name',' SD Linear vs SD Non Linear 2');
subplot(3,2,1:2)
plot(SD_Lin.t,SD_Lin.F,'b')
hold on
plot(SD_NL2.t1,SD_NL2.F1,'r','LineWidth',2)
grid on
xlabel('Time(s)')
ylabel('Force(N)')
title ('Control Force')
...
plot(SD_Lin.t,r2d(1)*SD_Lin.x(:,1),'b')
hold on
plot(SD_NL2.t1,r2d(1)*SD_NL2.x(:,1),'r','LineWidth',2)
xlabel('Time(s)')
ylabel('Angle(deg)')
title ('State x1: Angle of rotating actuator')
legend('x1 Sampled-Data Model','x1 Sampled-Data NL Model','location','northeast')
...
plot(SD_Lin.t,r2d(1)*SD_Lin.x(:,2),'b')
hold on
plot(SD_NL2.t1,r2d(1)*SD_NL2.x(:,2),'r','LineWidth',2)
xlabel('Time(s)')
ylabel('Angular Velocity(deg/s)')
title ('State x2: Angular velocity of rotating actuator')
legend('x2 Sampled-Data Model','x2 Sampled-Data NL Model','location','northeast')
...
plot(SD_Lin.t,r2d(2)*SD_Lin.x(:,3),'b')
hold on
plot(SD_NL2.t1,r2d(2)*SD_NL2.x(:,3),'r','LineWidth',2)
xlabel('Time(s)')
ylabel('Position(m)')
title ('State x3: Position of Translational oscillator')
legend('x3 Sampled-Data Model','x3 Sampled-Data NL Model','location','northeast')
...
plot(SD_Lin.t,r2d(2)*SD_Lin.x(:,4),'b')
hold on
plot(SD_NL2.t1,r2d(2)*SD_NL2.x(:,4),'r','LineWidth',2)
xlabel('Time(s)')
ylabel('Velocity')
title ('State x4: Velocity of Translational oscillator')
legend('x4 Sampled-Data Model','x4 Sampled-Data NL Model','location','northeast')
